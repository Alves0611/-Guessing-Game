import { initializeGame, checkGuess, incrementAttempts, getAttempts } from './IMC/gameUtils.js';
import { setDomElements, toggleScreens, clearInput } from './IMC/domUtils.js';
...
function handleTryClick(event) {
    ...
    // Check if the number is within the range of 0 to 10
